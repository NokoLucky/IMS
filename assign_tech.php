...
$callNum  = $_GET['callNum'];
  ...
  if(isset($_POST['submit']))
  {
   $t_id     = htmlentities($_POST['t_id']);
    ...
    $chartforum->insert_assigned($callNum, $t_id, $user_id);
    $chartforum->update_call_status($callNum);
    header("Location: admin_home.php");

  }

  $techs = $chartforum->select_technician($callNum);
?>
...
font-size: 16px;"> Last account activity : <?php echo date('H:i');?> &nbsp; <a href="logout.php" class="btn btn-danger square-btn-adjust">Logout</a></div>
        ...
        <!-- /. NAV SIDE  -->
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Assign this call to the technician</h2>   
            ...
            <div class="row">
               ...
               <a href="assign_call.php" class="btn btn-primary ">Back</a>
                <!-- /. ROW  -->
