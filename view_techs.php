...
font-size: 16px;"> Last account activity : <?php echo date('H:i');?> &nbsp; <a href="logout.php" class="btn btn-danger square-btn-adjust">Logout</a></div>
        ...
        <!-- /. NAV SIDE  -->
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>View All Active Technicians</h2>   
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php foreach ($selec as $row) {?>
                                          <tr>
                                          <td><a href="delete_tech.php?t_id=<?php echo $row['t_id'];?>" class="fa fa-trash fa-2x" onclick='return confirm("Are you sure you want to delete this technician?")'></a></td>
