...
$selec = $chartforum->select_open_calls();
?>
...
font-size: 16px;"> Last account activity : <?php echo date('H:i');?> &nbsp; <a href="logout.php" class="btn btn-danger square-btn-adjust">Logout</a></div>
        ...
        <!-- /. NAV SIDE  -->
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>View All Un-Assigned Calls</h2>   
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php foreach ($selec as $row) {?>
                                          <tr>
                                          <td><a href="assign_tech.php?callNum=<?php echo $row['callNum']?>&user_id=<?php echo $row['user_id']?>" class="btn btn-primary ">assing</a></td>
