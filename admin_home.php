...
$select = $chartforum->select_users($user_id);
?>
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">IMS Admin</a> 
            </div>
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                     ...
                     <li>
                        <a  href="add_tech.php"><i class="fa fa-user fa-3x"></i>Add Technician</a>
                    </li>
                    <li>
                        <a  href="view_calls.php"><i class="fa fa-phone fa-3x"></i>View All Logged Incidents</a>
                    </li>
                     <li >
                        <a   href="view_techs.php"><i class="fa fa-table fa-3x"></i>View All Technicians</a>
                    </li>
				    <li >
                        <a   href="assign_call.php"><i class="fa fa-plus fa-3x"></i>Assign An Incident To Technician</a>
                    </li>					
					 <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="log.php">Add Technician</a>
                            </li>
                            <li>
                                <a href="view_calls.php">View All Logged Incidents</a>
                            </li>
                            <li>
                                <a href="view_techs.php">View All Technicians</a>
                            </li>
							<li>
							<a href="assign_call.php">Assign Incident To Technician</a>
							 </li>
                        </ul>
                ...
                <div class="row">
                    <div class="col-md-12">
                     <h2>Admin Dashboard</h2>   
                        <h4>Welcome Administrator, Its great to see you. </h4>
                    </div>
                </div>              
