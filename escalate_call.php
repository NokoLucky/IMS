...
font-size: 16px;"> Last account activity : <?php echo date('H:i');?> &nbsp; <a href="logout.php" class="btn btn-danger square-btn-adjust">Logout</a></div>
        ...
        <!-- /. NAV SIDE  -->
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Transfer Incident To Another Technincian</h2>   
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php foreach ($selec as $row) {?>
                                          <tr>
                                          <td><a href="escalate.php?callNum=<?php echo $row['callNum']?>&d_id=<?php echo $row['d_id']?>" class="btn btn-primary"><?php echo $row['callNum']?></a></td> 
