    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">IMS User</a> 
            </div>
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                     ...
                     <li>
                        <a  href="log.php"><i class="fa fa-phone-square fa-3x"></i> Log An Incident</a>
                    </li>
                    <li >
                        <a   href="view_mine.php"><i class="fa fa-table fa-3x"></i>View Incident Status</a>
                    </li>
                    <li >
                        <a   href="view_all.php"><i class="fa fa-table fa-3x"></i>View Unattended Incidents</a>
                    </li>
                    <li >
                        <a   href="tech_responsible.php"><i class="fa fa-table fa-3x"></i> View Technician Responsible</a>
                    </li>					
					 <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="log.php">Log An Incident</a>
                            </li>
							 <li>
							<a href="view_mine.php"> View Incident Status</a>
							 </li>
                             <li>
                            <a href="tech_responsible.php"> View Technician Responsible</a>
                             </li>
                        </ul>
                ...
                <div class="row">
                    <div class="col-md-12">
                     ...
                     <?php foreach ($select as $row) { ?>
                       ...
                       <h4>   Welcome  <?php echo $row['name']; ?>  of <?php echo  $row['job'] ?>  department,  Its great to see you </h4>
                        <?php } ?>
                    </div>
                </div>              
